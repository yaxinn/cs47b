...
public class Graph
{
    ...
    // added fields for prim's algorithm
    private boolean undirect = false;
    public int cost = 0;
    public static boolean DEBUG = true;
    //////////////////

    public void setUndirect () {
        this.undirect = true;
    }

    public boolean getUndirect () {
        return this.undirect;
    }
    ...
    public void addEdge ( Edge e ) {
        addEdge (e.src.name, e.dest.name, e.cost);
    }
    ...
    /**
     * Print the graph in the form of adjacent vertex and 
     * description of the graph (i.e. directed or undirected )
     */
    private void printGraph ( ) {
        System.out.println ("\nundirected Graph: " + getUndirect());
        if (cost != 0)
        ...
        try
        {
            ...
            if (DEBUG) {
                ...
                System.out.print( "Available Algorithms:\n" +
                                  "\tu: unweighted shortest-path algorithm\n" +
                                  "\td: weighted shortest-path algorithm (Dijkstra's algorithm)\n" +
                                  "\tn: negative-weighted shortest-path algorithm\n" +
                                  "\ta: negative-weighted acyclic-graph shortest-path algorithm\n" +
                                  "\tp: undirected graph minimum spanning tree algorithm (Prim's algorithm)\n");
    ...
    public static void main( String [ ] args )
    {
        ...
        try
        {
            ...
            // check if user choose option "-u" ( undirected graph )
            if (args.length == 2 && args[1].equals("-u"))
                g.setUndirect();
            ...
            while( ( line = graphFile.readLine( ) ) != null )
            {
                ...
                try
                {
                    ...
                    // System.out.print(source + dest + cost);
                    // If the graph is undirected, for each edge, add both directions
                    if (g.getUndirect()) {
